...
using pkhmelyov.AbpReposterBot.Tests.DependencyInjection;
...
namespace pkhmelyov.AbpReposterBot.Tests
{
    ...
    public class AbpReposterBotTestModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            RegisterFakeService<AbpZeroDbMigrator<AbpReposterBotDbContext>>();
