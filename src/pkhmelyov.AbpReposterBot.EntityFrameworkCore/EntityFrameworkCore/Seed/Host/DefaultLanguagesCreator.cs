...
namespace pkhmelyov.AbpReposterBot.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AbpReposterBotConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AbpReposterBotDbContext context)
        {
            _context = context;
        }
